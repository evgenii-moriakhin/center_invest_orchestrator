...
class Worker:
    def __init__(self, worker_name, app_image, app_port, healthcheck_api, app_dockerfile, app_git_repo):
        ...
        self.app_runner = AppRunner(self.app_image, self.app_port, self.healthcheck_api, self.app_dockerfile, self.app_git_repo)
